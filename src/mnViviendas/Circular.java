...
public class Circular extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PORCENTAJES VIVIENDAS");

        jLabel2.setText("CISTERNA");

        jLabel3.setText("3R");

        jLabel4.setText("ILUM. INTELIGENTE");

        jLabel5.setText("LUC. AHORRADORES");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        datos.setValue("CISTERNA", n1);
        datos.setValue("3R", n2);
        datos.setValue("ILUM. INTELIGENTE", n3);
        datos.setValue("LUC. AHORRADORES", n4);
        
        JFreeChart grafico_circular = ChartFactory.createPieChart( 
                "Porcentaje de viviendas",  //NOMBRE DE LA GRAFICA
                datos,  //DATOS 
